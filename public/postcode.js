(function () {
  /*VERSION:211103*/ function checkWebviewCustomUA(a) {
    for (
  ...
  (postcodeUtils.param = (function (a) {
    ...
    (postcodeUtils.isAvailable = function (a) {
      return postcodeUtils.isUndefined(a) ||
    ...
    a.frame = (function () {
            ...
            function (a, i) {
              if ("reload" === a) {
                if ((b.focus(), f && f.document)) {
                  var k = f.document.getElementById(
                    j.getId("viewerFrame", d.viewerNo)
                  );
                  k && k.focus();
                }
              } else
                    ...
                    setTimeout(function () {
                      d.onComplete(i),
                        d.autoClose &&
                          ...
                          h.remove(e, c),
                          d.onClose !== g.EMPTY_FUNCTION &&
                            d.onClose(g.POPUP_CLOSE_STATE.COMPLETE));
                    }, 0);
            },
            d
          );
      ...
      function n(b, c) {
        ...
        try {
          ...
          if (e) {
            var f = c.popupTitle || "Daum Postcode Service",
              i = null,
              k = null,
        ...
        if (b.onClose !== g.EMPTY_FUNCTION) {
          ...
          c &&
            ...
            (c.data.closeCallbackTimer = setInterval(function () {
              ...
              d ||
                void 0 !== a.closed ||
                (d = void 0 === a.window || null === a.window ? !0 : !1),
                d &&
                  (clearInterval(c.data.closeCallbackTimer),
